...
const Home = () => {
  return (
    <div id="home">
        <div class="detail">
            <h2 >Hi, 👋 I am<br/> <span id="user-detail-name">Sumit Kumar</span></h2>
            <p id="user-detail-intro">I am a Fullstack web developer with a focus on the MERN stack.
            ...
            <a id="resume-link-2" href={CV} download={"Sumit-Kumar-Resume"}
        ...
        <div className='container__img'>
            <div className='pro__img'>
                <img class='home-img' src={ME} alt="About" />
            </div>
         </div>
      </div>
